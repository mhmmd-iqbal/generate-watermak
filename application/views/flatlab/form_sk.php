    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="breadcrumb">
          ...
          <li class="active">Input Data SK</li>
        </ul>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="panel" id="panel">
          ...
          <div class="panel-body">
            <form method="post" enctype="multipart/form-data" action="<?=site_url()?>/Action/Action_watermark/tb_sk">
              <div class="row" style="padding-left: 5%;padding-right: 5%; ">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-3">Produk Hukum</div>
                      <div class="col-md-9">
                        <select class="form-control" name="produk">
                          <option value="SK Direktur Utama">SK Direktur Utama</option>
                          <option value="SK Direktur Keuangan">SK Direktur Keuangan</option>
                        </select>
                    </div>
                    </div>
                  </div>
